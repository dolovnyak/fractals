...
/*   Updated: 2019/05/16 23:11:21 by sbecker          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_root_and_set_args(t_fractal2d *conf, int *err)
{
	...
	kernel = conf->cl->kernel_newton1;
	roots.root1.x = -0.5;
	roots.root1.y = 0.8660254038;
	roots.root2.x = -0.5;
	roots.root2.y = -0.8660254038;
	roots.root3.x = 1.0;
	roots.root3.y = 0.0;
	...
	*err |= clSetKernelArg(kernel, 11, sizeof(int), &conf->color_mult);
}
