...
__kernel void render_safety(__global char* img, int width, int height,
		int y, int objects_num, int lights_num, t_canvas canvas,
...
__kernel void render_fast(__global char* img, int width, int height,
