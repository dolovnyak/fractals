...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/16 21:03:12 by sbecker           #+#    #+#             */
/*   Updated: 2019/05/16 23:10:38 by sbecker          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		int *z, size_t global_size)
{
	...
	err = clSetKernelArg(cl->kernel_julia3d, 0, sizeof(cl_mem),
			&mem_arr_structs);
	err = clSetKernelArg(cl->kernel_julia3d, 1, sizeof(int), z);
	err = clSetKernelArg(cl->kernel_julia3d, 2, sizeof(t_fractal3d), conf);
	if (err != 0)
		ft_printf("set kernel args - error\n");
	err = clEnqueueNDRangeKernel(cl->queue, cl->kernel_julia3d,
...
void					julia_3d(int *objects_num, t_object3d **objects,
