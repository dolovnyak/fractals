...
__kernel void mandelbrot_2d(__global int* img, double step_x, double step_y, int depth,
...
__kernel void mandelbrot_2d_pow5(__global int* img, double step_x, double step_y, int depth,
		int width, double left_b, double top_b, double radius, int color_mult)
{
	t_complex	z_const, z;
	int		i = -1;
