...
/*   Updated: 2019/05/16 23:11:07 by sbecker          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	set_args_and_run(t_fractal2d *conf, cl_mem *mem_img)
{
	...
	kernel = conf->cl->kernel_burning_ship2d_pow5;
...
static int	burning_ship2d_refresh(t_fractal2d *conf)
{
	int		err;
	cl_mem	mem_img;
...
void		burning_ship_2d_pow5(t_cl *cl)
{
	...
	mlx_loop_hook(conf.mlx->mlx, &burning_ship2d_refresh, &conf);
