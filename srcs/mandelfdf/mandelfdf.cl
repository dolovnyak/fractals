static void	get_rotation_and_draw(int gid, int width, int height, int z, double angle_x,
...
__kernel void mandelbrot_fdf(__global int* img, double step_x, double step_y, int depth,
	int width, int height, int center_x, int center_y, int zoom,
	double left_b, double top_b, double angle_x, double angle_z, int color_mult)
{
